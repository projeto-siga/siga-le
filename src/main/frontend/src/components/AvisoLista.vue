        ...
        <div class="col-sm-2 ml-sm-auto">
          <div class="btn-group btn-block" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
              <router-link class="dropdown-item" v-if="$parent.test.properties['siga-le.env'] !== 'prod'" :to="{name:'Avisos Confirmados Recentemente'}" tag="a" exact>Consultar Confirmados</router-link>
